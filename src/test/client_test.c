...
zclient(void) {
    ...
    // 创建新项目
    char zStrBuf[] = "{\"OpsId\":1,\"ProjId\":998,\"RevId\":0,\"FileId\":0,\"HostId\":0,\"CacheId\":0,\"DataType\":-1,\"data\":\"998 /home/git/998_X https://git.coding.net/kt10/zgit_shadow.git master git\"}";

    // 锁定
    //char zStrBuf[] = "{\"OpsId\":2,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":-1,\"data\":\"\"}";

    // 解锁
    //char zStrBuf[] = "{\"OpsId\":3,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":-1,\"data\":\"\"}";

    // 更新major IP数据
    //char zStrBuf[] = "{\"OpsId\":4,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":-1,\"data\":\"10.10.40.49\"}";

    // 更新all IP数据
    //char zStrBuf[] = "{\"OpsId\":5,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":-1,\"data\":\"10.10.40.49\"}";

    // 查询尚未布署成功的主机列表
    //char zStrBuf[] = "{\"OpsId\":6,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":-1,\"data\":\"\"}";

    // 查询提交版本号列表
    //char zStrBuf[] = "{\"OpsId\":9,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":0,\"data\":\"\"}";

    // 查询已布署版本号列表
    //char zStrBuf[] = "{\"OpsId\":9,\"ProjId\":998,\"RevId\":-1,\"FileId\":-1,\"HostId\":0,\"CacheId\":-1,\"DataType\":1,\"data\":\"\"}";

    // 打印差异文件列表
    //char zStrBuf[] = "{\"OpsId\":10,\"ProjId\":998,\"RevId\":4,\"FileId\":-1,\"HostId\":0,\"CacheId\":1000000000,\"DataType\":0,\"data\":\"\"}";

    // 打印差异文件内容
    //char zStrBuf[] = "{\"OpsId\":11,\"ProjId\":998,\"RevId\":1023,\"FileId\":0,\"HostId\":0,\"CacheId\":1000000000,\"DataType\":0,\"data\":\"\"}";

    // 布署
    //char zStrBuf[] = "{\"OpsId\":12,\"ProjId\":998,\"RevId\":3,\"FileId\":-1,\"HostId\":0,\"CacheId\":1502258904,\"DataType\":0,\"data\":\"\"}";

    // 撤销
    //char zStrBuf[] = "{\"OpsId\":13,\"ProjId\":998,\"RevId\":3,\"FileId\":-1,\"HostId\":0,\"CacheId\":1502238530,\"DataType\":1,\"data\":\"\"}";
